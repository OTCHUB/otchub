    ...
    <div className="border border-green-500/30 bg-black p-3">
      ...
      <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-3">
        ...
        <Field
          ...
          sub={`stock included: ${fmtSol(bestAccrued, 3)}`}
      ...
      <div className="mt-2 space-y-1 font-mono text-[11px] sm:text-xs">
        ...
        <div className="flex justify-between">
          <span className="text-green-500/50">&gt; SECONDARY = floor + bundled accrued stock holding</span>
          <span className="text-cyan-400">{fmtUsd(latest?.secondary_cost_usd)}</span>
        </div>
        <div className="flex justify-between">
          <span className="text-green-500/50">&gt; EFFECTIVE_SEC = floor − stock (net cost to acquire desk + claim)</span>
