      ...
      <div className="mt-3 h-72">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart layout="vertical" data={data} margin={{ top: 4, right: 16, bottom: 0, left: 10 }}>
            ...
            <XAxis type="number" stroke="#1a6b3a" fontSize={10} tick={{ fill: "#2a8b4a" }} tickFormatter={(v) => `${v}`} />
            <YAxis type="category" dataKey="symbol" stroke="#1a6b3a" fontSize={10} tick={{ fill: "#2a8b4a" }} width={72} />
            <Tooltip
