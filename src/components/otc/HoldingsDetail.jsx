    ...
    <Dialog open={!!h} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="max-w-md border border-green-500/40 bg-black font-mono text-green-400">
        ...
        <div className="mt-3 flex flex-wrap gap-2 text-[10px]">
          <a href={`https://magiceden.io/item-details/${h.asset_id}`} target="_blank" rel="noreferrer" className="border border-emerald-500/50 px-2 py-1 font-bold text-emerald-400 hover:bg-emerald-500/10">[BUY_ON_ME ↗]</a>
